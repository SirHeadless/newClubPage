(function () {
    ...
    .controller('personsFormController', personsFormController)
    .controller('alertMessagesController', alertMessagesController);
    
    PersonsListController.$inject = ['$scope', '$rootScope', 'PersonService'];


	 function PersonsListController($scope, $rootScope, PersonService) {
...
//	        $scope.gridOptions.selectAll(false);
	...
	function personsFormController($scope, $rootScope, PersonService) {
