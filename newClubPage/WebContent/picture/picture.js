(function () {
    ...
    PictureUploadController.$inject = ['$scope', '$rootScope', 'PictureService'];


/*	 function PictureUploadController($scope, $rootScope) {
...
//	        $scope.gridOptions.selectAll(false);
	...
	function PictureUploadController($scope, $rootScope, PictureService) {
	    ...
	    $scope.uploadPicture = function () {
	    	PictureService.Save($scope.file).$promise.then(
	            function () {
	    ...
	    $scope.$on('deletePerson', function (event, id) {
	        PictureService.delete({id: id}).$promise.then(
	            function () {
	                // Broadcast the event to refresh the grid.
	                $rootScope.$broadcast('refreshGrid');
...
/*	
	...
	function alertMessagesController($scope) {
