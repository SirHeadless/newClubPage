...
import business.DemoAuthenticator;
...
//        if (!"GET".equals(requestCtx.getMethod()) && !path.startsWith( "/demo-business-resource/login")) {
...
//        // For any pther methods besides login, the authToken must be verified
        if ( path.startsWith( "/demo-business-resource/test2" ) ) {
            String authToken = requestCtx.getHeaderString( DemoHTTPHeaderNames.AUTH_TOKEN );
