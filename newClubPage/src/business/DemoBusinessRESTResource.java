...
public class DemoBusinessRESTResource implements DemoBusinessRESTResourceProxy {
    ...
    public Response login(
        ...
        try {
          ...
          /*  TODO: Add some configuration to the Cookie Look:
            	https://stormpath.com/blog/where-to-store-your-jwts-cookies-vs-html5-web-storage
            		JWT Cookie Storage*/
            NewCookie cookie = new NewCookie("XSRF-TOKEN", authToken, "/", "localhost", "", 10000, false, false);
            
            Response resp = getNoCacheResponseBuilder( Response.Status.OK ).cookie(cookie).entity( jsonObj.toString() ).build();
	...
	public Response demoGetTest() {
        ...
        JsonObjectBuilder jsonObjBuilder = Json.createObjectBuilder();
        jsonObjBuilder.add( "test", "This is data from the server" );
        JsonObject jsonObj = jsonObjBuilder.build();
	...
	public Response demoGetAllUser() {
		// TODO Auto-generated method stub
        JsonObjectBuilder jsonObjBuilder = Json.createObjectBuilder();
        jsonObjBuilder.add( "test", "testYes" );
        JsonObject jsonObj = jsonObjBuilder.build();
		return getNoCacheResponseBuilder( Response.Status.OK ).entity( jsonObj.toString() ).build();
	}
